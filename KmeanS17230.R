...
titanic$AgeCat[titanic$Age>=48&titanic$Age<=65] <- "48-65"
...
View(titanic)
#2.9
write.csv(titanic,file = "C:/Users/hp-pc/Desktop/DV/Exercise 7/kmean/titanicNew.csv")
#3.0
...
train = -test
trainig_data = decision_tree[train, ]
...
library(rattle)
#3.4
tree_model=rpart(Survived ~ Pclass + Sex +AgeCat +Embarked + SibSpCat + ParchCat, data= trainig_data,method = "class",
...
write.csv(titanicUpdated,file = "C:/Users/hp-pc/Desktop/DV/Exercise 7/kmean/titanicUpdated.csv")
...
plot(totwss,xlab = "Number of Cluster" , type ="b", 
     ylab = "Total within Sum of Sqaure")
plot(btwss,xlab = "Number of Cluster" , type ="b", 
     ylab = "Total between Sum of Sqaure")
#5.1
